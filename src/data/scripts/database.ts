...
export const Partners: Partner_groups[] = [
  {
    ...
    logo: import("../images/partners/aclevo_current.png")
  }
]
...
export const LogoHistory: Logo_groups[] = [
  {
    ...
    image: import("../images/logos/ttnrtlogo_v3.png"),
    started_on: 2025,
    until_now: "now"
  },
  {
    ...
    image: import("../images/logos/ttnrtlogo_v2.png"),
    started_on: 2023,
    until_now: 2025
  },
  {
    ...
    image: import("../images/logos/ttnrtlogo_v1.png"),
    started_on: 2022,
    until_now: 2023
  }
]
...
export const Services: Service_groups[] = [
        ...
        cards: [
          {
            ...
            content:
              "You can easily deploy your own website to the platform using the CI interface! Our documentation has all of the information that you need in order to accomplish this goal!",
  ...
  },
  {
    ...
    alert:
      "Our new account management system is in development at this time, so there might be some bugs or issues that you might run into! If you see any issues that requires our attention, please contact our support team and include the error stack message (if possible) with your message!",
    sections: [
      {
        title: "How it works",
...
export const Projects: Service_groups[] = [
  ...
  },
  {
    ...
    alert:
      "Currently, our AI model is in it's early stages, meaning that some features will be either broken or not available at all! Please help us out in making it work well by going to the Huggingface repository for that!",
    sections: [
      {
        title: "How it works",
